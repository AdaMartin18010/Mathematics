...
- [03-可计算性与复杂性分层 | Computability \& Complexity Hierarchies](#03-可计算性与复杂性分层--computability--complexity-hierarchies)
  - [目录](#目录)
  - [1. 主题简介 | Topic Introduction](#1-主题简介--topic-introduction)
  - [2. 可计算性理论 | Computability Theory](#2-可计算性理论--computability-theory)
  - [3. 复杂性分层 | Complexity Hierarchies](#3-复杂性分层--complexity-hierarchies)
  - [4. 递归扩展计划 | Recursive Expansion Plan](#4-递归扩展计划--recursive-expansion-plan)
  - [概念定义 | Concept Definition](#概念定义--concept-definition)
    - [可计算性分层 | Computability Hierarchy](#可计算性分层--computability-hierarchy)
    - [复杂性类 | Complexity Classes](#复杂性类--complexity-classes)
    - [P类问题 | P Class Problems](#p类问题--p-class-problems)
    - [NP类问题 | NP Class Problems](#np类问题--np-class-problems)
    - [NP完全问题 | NP-Complete Problems](#np完全问题--np-complete-problems)
    - [递归函数 | Recursive Functions](#递归函数--recursive-functions)
  - [5. 理论历史与代表人物 | Theoretical History \& Key Figures](#5-理论历史与代表人物--theoretical-history--key-figures)
    - [5.1 图灵与可计算性 | Turing \& Computability](#51-图灵与可计算性--turing--computability)
    - [5.2 库克与NP完全性 | Cook \& NP-Completeness](#52-库克与np完全性--cook--np-completeness)
    - [5.3 卡普与NP完全性 | Karp \& NP-Completeness](#53-卡普与np完全性--karp--np-completeness)
    - [5.4 萨维奇与PSPACE | Savitch \& PSPACE](#54-萨维奇与pspace--savitch--pspace)
    - [5.5 西普瑟与复杂性理论 | Sipser \& Complexity Theory](#55-西普瑟与复杂性理论--sipser--complexity-theory)
  - [6. 现代发展与前沿挑战 | Modern Development \& Frontier Challenges](#6-现代发展与前沿挑战--modern-development--frontier-challenges)
    - [6.1 量子复杂性理论 | Quantum Complexity Theory](#61-量子复杂性理论--quantum-complexity-theory)
    - [6.2 人工智能与复杂性理论 | AI \& Complexity Theory](#62-人工智能与复杂性理论--ai--complexity-theory)
  - [7. 跨学科影响与未来展望 | Interdisciplinary Impact \& Future Prospects](#7-跨学科影响与未来展望--interdisciplinary-impact--future-prospects)
    - [7.1 密码学的影响 | Impact on Cryptography](#71-密码学的影响--impact-on-cryptography)
    - [7.2 算法设计的影响 | Impact on Algorithm Design](#72-算法设计的影响--impact-on-algorithm-design)
