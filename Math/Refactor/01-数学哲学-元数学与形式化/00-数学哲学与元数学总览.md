...
- [ ] 三大主义定义与代表观点（对标 Wikipedia/Stanford Encyclopedia of Philosophy）
- [ ] 元数学四支柱与典型定理标准表述（Gödel/Compactness/L-S/Halting）
- [ ] 案例：形式系统内外"真理与可证性"对照卡片
- [ ] 至少5条权威参考：SEP/Wikipedia/经典文献
- [ ] Mermaid：哲学流派→形式化→元理论→影响 的因果链

## 进度与断点

- 日期：2024-12-19
- 已完成：对标清单建立
- 下一步：补充"真理/可证性"对照卡片与参考外链
...
- 逻辑主义的雄心与挫败
  - 罗素（Russell）：
    > “数学似乎与逻辑是同一的。”（Principia 相关论述脉络）
  - 罗素悖论暴露朴素集合论的缺陷，迫使逻辑主义引入类型论等复杂装置。
- 形式主义与希尔伯特纲领
  - 希尔伯特（Hilbert，1930）：
    > “Wir müssen wissen — wir werden wissen.”
  - 纲领要义：以有限主义方法证明整个数学的一致性与完备性。
- 直觉主义的挑战
  - 布劳威尔（Brouwer，1908）：
    > “排中律在无限领域上是不可靠的。”
  - 海廷（Heyting）：直觉主义逻辑的形式化，拒绝非构造证明。
- 不完备性的震荡
  - 哥德尔（Gödel，1931）：
    > “在任何足够强而一致的系统中，存在既不可能被证明也不可能被证伪的命题。”（意译）
  - 含义：终结"绝对基础"的梦想，迫使哲学立场重估。
- 语义真与模型视角
  - 塔斯基（Tarski，1933）：
...
- 弗雷格/罗素（19世纪末–20世纪初）→ 希尔伯特纲领（1900）→ 布劳威尔直觉主义（1908）→ 哥德尔（1931）→ 塔斯基（1933）→ 图灵/丘奇（1936）

> 注：原话引文多为意译/经典表述，具体出处建议在对应专题中补充页码与版本信息。

### 引文与参考（严格体例）

- Frege, G. (1884). Die Grundlagen der Arithmetik. Breslau: Koebner. [专题：`./01-数学哲学的三大主义.md`]
- Russell, B., & Whitehead, A. N. (1910–1913). Principia Mathematica (Vols. I–III). Cambridge University Press. [专题：`./01-数学哲学的三大主义.md`]
- Hilbert, D. (1900). Mathematische Probleme. Nachrichten von der Gesellschaft der Wissenschaften zu Göttingen.（1930 引语见 Reid, 1970）[专题：`./02-形式化方法与公理系统.md`]
- Brouwer, L. E. J. (1908). De onbetrouwbaarheid der logische principes. Tijdschrift voor Wijsbegeerte, 2, 152–158. [专题：`./01-数学哲学的三大主义.md`]
- Heyting, A. (1930). Die formalen Regeln der intuitionistischen Logik. Sitzungsberichte der Preußischen Akademie der Wissenschaften. [专题：`../02-数学基础与逻辑/02-数理逻辑/`]
- Gödel, K. (1931). Über formal unentscheidbare Sätze... Monatshefte für Mathematik und Physik, 38, 173–198. [专题：`../02-数学基础与逻辑/03-证明论/00-证明论总览.md`]
- Tarski, A. (1944). The Semantic Conception of Truth... PPR, 4(3), 341–376；(1956) Logic, Semantics, Metamathematics. [专题：`./02-形式化方法与公理系统.md`]
- Turing, A. M. (1936/1950). On Computable Numbers... / Computing Machinery and Intelligence. [专题：`../02-数学基础与逻辑/05-递归论/00-递归论总览.md`]
