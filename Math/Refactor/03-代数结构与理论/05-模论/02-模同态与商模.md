...
1. [引言](#1-引言)
2. [模同态](#2-模同态)
   1. [模同态的定义与基本性质](#21-模同态的定义与基本性质)
   2. [核与像](#22-核与像)
   3. [同态基本定理](#23-同态基本定理)
   4. [模同构](#24-模同构)
3. [商模](#3-商模)
   1. [商模的定义与构造](#31-商模的定义与构造)
   2. [商模的性质](#32-商模的性质)
   3. [商模的普遍性质](#33-商模的普遍性质)
4. [模的正合列](#4-模的正合列)
   1. [正合列的定义](#41-正合列的定义)
   2. [短正合列](#42-短正合列)
   3. [蛇引理](#43-蛇引理)
...
模同态和商模是模论中的核心概念，它们为研究模之间的关系和构造新模提供了基本工具。模同态是研究模之间结构保持映射的方式，而商模则是通过子模构造新模的重要手段。这两个概念共同构成了模论的基础框架，也是连接模论与其他代数结构的重要桥梁。
