...
- **Location**: `/01-核心内容/Refactor/01-哲学与元数学基础/`
- **Core Documents**:
...
- **Status**: Fully reconstructed and formalized
- **Location**: `/01-核心内容/Refactor/03-代数结构与理论/`
- **Core Documents**:
...
- **Status**: Fully reconstructed and formalized
- **Location**: `/01-核心内容/Refactor/04-微积分与分析/`
- **Core Documents**:
...
- **Status**: Fully reconstructed and formalized
- **Location**: `/01-核心内容/Refactor/05-几何与拓扑/`
- **Core Documents**:
...
- **Location**: `/01-核心内容/Refactor/06-数论与离散数学/`
- **Completed Documents**:
...
- **Location**: `/01-核心内容/Refactor/07-应用数学/`
- **Planned Documents**:
